<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
      <div class="sidebar-brand">
        <a href="index.html"> <img alt="image" src="assets/img/Capture.PNG" class="header-logo" /> <span
            class="logo-name"><span style="font-size:12px; color:#6777ef; text-transform:capitalize;">BUSINESS PORTAL</span>
        </a>
      </div>
...
<li><a class="nav-link" href="index.php?page=profile.php"><i class="fa fa-user-circle-o" style="font-size:19px;"></i><span>Profile</span></a></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="nav-link" href="index.php?page=chati.php">Chat</a></li>
        ...
        <li><a class="nav-link" href="index.php?page=blankk.php&name=Sheikh"><i data-feather="file"></i><span>Blank Page</span></a></li>
        ...
        <li><a class="nav-link" href="index.php?page=map.php"><i data-feather="map-pin"></i><span>Vector
              Map</span></a></li>
